# Инструкция по деплою Kafeshka

Этот документ содержит пошаговые инструкции по деплою всех компонентов платформы Kafeshka.
...
3. Запишите URL (например: `https://kafeshka-backend.railway.app`)
...
4. Запишите **Bot Username** (например: `@kafeshka_bot`)
...
1. В Railway Dashboard → Settings → Networking
2. Нажмите **Generate Domain** или добавьте свой домен
3. Запишите URL (например: `https://kafeshka-bot.railway.app`)
...
3. Запишите URL (например: `https://kafeshka.vercel.app`)
...
Готово! Ваша платформа Kafeshka должна быть полностью развернута и работать. 🚀

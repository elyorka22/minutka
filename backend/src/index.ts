...
import menuItemCategoryRelationsRouter from './routes/menuItemCategoryRelations';
...
app.use('/api/menu-items', menuItemCategoryRelationsRouter);
app.use('/api/categories', menuItemCategoryRelationsRouter);

    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4 pb-2">
        <div className="flex flex-col sm:flex-row gap-3 items-stretch sm:items-center">
          ...
          {/* Кнопка с ссылкой рядом со строкой поиска */}
            ...
            if (categoryWithButton) {
              return (
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 px-4 sm:px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-medium text-sm md:text-base whitespace-nowrap"
                >
                  ...
                  <span className="hidden sm:inline">{categoryWithButton.button_text}</span>
